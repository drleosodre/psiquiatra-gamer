(function () {
  ...
  var ICONS = {
    ...
    li: '<svg viewBox="0 0 24 24" width="21" height="21" aria-hidden="true"><text x="12" y="17" font-family="Arial, sans-serif" font-weight="700" font-size="13.5" text-anchor="middle" fill="currentColor">in</text></svg>',
    ...
    fb: '<svg viewBox="0 0 24 24" width="20" height="20" aria-hidden="true"><path d="M14.5 9H13V7.5c0-.6.4-.7.7-.7h1.3V4.3L13 4.3c-2.3 0-3 1.7-3 2.8V9H8.5v2.5H10V20h3v-8.5h2l.3-2.5z" fill="currentColor"/></svg>',
