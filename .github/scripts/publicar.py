...
def main():
    ...
    if not pendentes:
        # Sai com erro DE PROPOSITO: fila vazia nao e' sucesso, e' site parado.
        # Com exit 1 a execucao fica vermelha no painel e o GitHub manda e-mail.
        # Sem isso o robo saia em silencio e ninguem percebia (aconteceu em 08/2026).
        print("::error::Fila de publicacao VAZIA. Nenhum post pendente em agendados/fila.json.")
        print("Nada foi publicado. Escreva os proximos posts (PT + EN) e reabasteca a fila.")
        sys.exit(1)
